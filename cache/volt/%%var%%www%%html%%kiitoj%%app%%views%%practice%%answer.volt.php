          ...
          <section class="wrapper">
			...
			<div class="col-md-12">
                      <div class="content-panel">
                          <h4><i class="fa fa-angle-right"></i> <?php echo $ques->q_name; ?> </h4><hr>

			  <h5><i class="fa fa-anchor"></i> Description: </h5><br><?php echo $ques->q_description; ?><hr><br>
			  <h5><i class="fa fa-anchor"></i> Constraints: </h5><br><?php echo $ques->q_constraint; ?><hr><br>
			  <h5><i class="fa fa-anchor"></i> Score: </h5><br><?php echo $ques->q_score; ?><hr><br>
